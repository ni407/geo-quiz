...
export const geographyData: GeographyData = {
            ...
            geometries: [
                ...
                },
                {
                    ...
                    properties: {
                        ...
                        region: 'ヨーロッパ',
                        jpNames: ['ボスニア・ヘルツェゴビナ', 'ボスニアヘルツェゴビナ'],
                        coordinates: [18.4167, 43.8667],
                    },
                },
                {
                    type: 'Polygon',
                ...
                },
                {
                    ...
                    properties: {
                        ...
                        region: 'アフリカ',
                        jpNames: ['中央アフリカ', 'ちゅうおうあふりか'],
                        coordinates: [18.5667, 4.3667],
                    },
                },
                {
                    type: 'MultiPolygon',
                ...
                },
                {
                    ...
                    arcs: [
                        [
                            216, 217, 218, 219, -56, 220, 221, 222, -10, 223, -13, 224, -127, 225,
                            226,
                        ],
                    ],
                    id: 'COD',
                    properties: {
                        ...
                        region: 'アフリカ',
                        jpNames: ['コンゴ民主共和国', 'こんごみんしゅきょうわこく'],
                ...
                },
                {
                    ...
                    properties: {
                        name: 'Congo',
                        region: 'アフリカ',
                        jpNames: ['コンゴ共和国', 'こんごきょうわこく'],
                        coordinates: [15.2833, -4.2667],
                    },
                },
                {
                    type: 'Polygon',
                ...
                },
                {
                    ...
                    properties: {
                        ...
                        region: '北アメリカ',
                        jpNames: ['ドミニカ共和国', 'どみにかきょうわこく'],
                        coordinates: [-69.8908, 18.479],
                    },
                },
                {
                    type: 'Polygon',
                ...
                },
                {
                    ...
                    properties: {
                        name: 'French Guiana',
                        region: '南アメリカ',
                        jpNames: ['フランス領ギアナ', 'ふらんすりょうぎあな'],
                        coordinates: [-52.3031, 4.9369],
                    },
                },
                {
                    type: 'Polygon',
                ...
                },
                {
                    ...
                    properties: {
                        ...
                        region: 'アフリカ',
                        jpNames: ['赤道ギニア', 'せきどうぎにあ'],
                        coordinates: [8.7833, 3.75],
                    },
                },
                {
                    type: 'MultiPolygon',
                ...
                },
                {
                    ...
                    arcs: [
                        [
                            420, 421, 422, 423, 424, 425, 426, 427, 428, 429, 430, 431, 432, -195,
                            433,
                        ],
                    ],
                    id: 'KAZ',
                ...
                },
                {
                    ...
                    properties: {
                        ...
                        region: 'ヨーロッパ',
                        jpNames: ['北マケドニア', 'きたまけどにあ'],
                        coordinates: [21.4333, 42.0],
                    },
                },
                {
                    type: 'Polygon',
                    ...
                    arcs: [
                        ...
                        [
                            [
                                ...
                                -198, -499, 590, 591, -496, 592, -494, 593, -492, -196, -433, 594,
                                -431, 595, 596, -428, 597, -426, 598, 599, 600, -55, 601, -322, 602,
                                -320, 603, 604, 605, 606, 607, 608, 609, 610, 611, -95, 612, -93,
                                -474, -287, 613, 614, -299, 615,
                            ],
                        ],
                        [[616]],
                        [[617]],
                ...
                },
                {
                    ...
                    properties: {
                        name: 'South Sudan',
                        region: 'アフリカ',
                        jpNames: ['南スーダン', 'みなみすーだん'],
                        coordinates: [31.6, 4.85],
                    },
                },
                {
                    type: 'Polygon',
                ...
                },
                {
                    ...
                    properties: {
                        name: 'Timor',
                        region: 'アジア',
                        jpNames: ['東ティモール', 'ひがしてぃもーる'],
                        coordinates: [125.5667, -8.55],
                    },
                },
                {
                    type: 'Polygon',
                    ...
                    properties: {
                        ...
                        region: '北アメリカ',
                        jpNames: ['トリニダード・トバゴ', 'トリニダードトバゴ'],
                        coordinates: [-61.5167, 10.6667],
                    },
                },
                {
                    type: 'Polygon',
                ...
                },
                {
                    ...
                    arcs: [
                        [
                            685, -611, 686, -609, 687, 688, 689, -605, 690, -572, -477, -571, -362,
                            -654, -563, -97,
                        ],
                    ],
                    id: 'UKR',
                ...
                },
                {
                    ...
                    properties: {
                        name: 'United States',
                        region: '北アメリカ',
                        jpNames: ['アメリカ合衆国', 'アメリカ', 'あめりかがっしゅうこく'],
                ...
                },
                {
                    ...
                    properties: {
                        name: 'South Africa',
                        region: 'アフリカ',
                        jpNames: ['南アフリカ', 'みなみあふりか'],
                        coordinates: [28.1874, -25.7461],
                    },
                },
                {
                    type: 'Polygon',
                ...
                },
                {
                    ...
                    properties: {
                        ...
                        region: 'オセアニア',
                        jpNames: ['マーシャル', 'マーシャル諸島', 'まーしゃるしょとう'],
                        coordinates: [171.3833, 7.1333],
                    },
                },
                {
                    type: 'MultiPolygon',
                    ...
                    properties: {
                        ...
                        region: 'オセアニア',
                        jpNames: ['ミクロネシア連邦', 'ミクロネシア', 'みくろねしあれんぽう'],
                        coordinates: [158.15, 6.9167],
                    },
                },
                {
                    type: 'Polygon',
                ...
                //元の定義だと、広い島のようになってしまうため、771で再定義
                // {
                //     type: 'Polygon',
                ...
                },
                {
                    ...
                    properties: {
                        name: 'Dominica',
                        region: '北アメリカ',
                        jpNames: ['ドミニカ国', 'どみにかこく'],
                        coordinates: [-61.3833, 15.3],
                    },
                },
                {
                    type: 'Polygon',
                ...
                },
                {
                    ...
                    properties: {
                        ...
                        region: '北アメリカ',
                        jpNames: ['セントクリストファー・ネイビス', 'セントクリストファーネイビス'],
                        coordinates: [-62.7333, 17.3],
                    },
                },
                {
                    type: 'Polygon',
    ...
    arcs: [
        ...
        //クック諸島（東西南北で定義すると、大きい島のようになってしまうため、首都のみ
        [
            [-159.7762, -21.2335],
            [-159.7762, -21.2335],
        ],
        //ツバル（東西南北で定義すると、大きい島のようになってしまうため、首都のみ
        [
            [179.2167, -8.5167],
            [179.2167, -8.5167],
        ],
